...
const popup_size = [150,50]                 // Размер уведомления при нажатии на датчик
const popup_livetime = 2000                 // Время жизни уведомления
const popup_moving_thread_time = 25         // Время в МС сколько раз будет обновляться позиция уведомления